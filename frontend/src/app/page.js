...
export default function Home() {
  ...
  return (
    <main className="bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-200 font-sans min-h-screen flex flex-col selection:bg-orange-500 selection:text-white transition-colors duration-300">
      ...
      {/* Hero */}
      <section className="relative pt-12 pb-16 sm:pt-16 sm:pb-24 lg:pt-32 lg:pb-48 px-6 lg:px-12 overflow-hidden bg-white dark:bg-slate-900 transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <div className="text-center lg:text-left">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-extrabold text-slate-900 dark:text-white mb-6 leading-[1.1] tracking-tight">
      ...
      <section className="bg-slate-900 dark:bg-slate-950 py-16 px-6 relative overflow-hidden transition-colors duration-300">
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 divide-x divide-slate-800 text-center relative z-10">
          <div className="px-4">
            <h4 className="text-2xl sm:text-3xl md:text-4xl font-black text-white mb-2">100%</h4>
            <p className="text-slate-400 font-medium">Participación ciudadana</p>
          </div>
          <div className="px-4">
            <h4 className="text-2xl sm:text-3xl md:text-4xl font-black text-orange-500 mb-2">+24h</h4>
            <p className="text-slate-400 font-medium">Monitoreo continuo</p>
          </div>
          <div className="px-4">
            <h4 className="text-2xl sm:text-3xl md:text-4xl font-black text-white mb-2">GPS</h4>
            <p className="text-slate-400 font-medium">Geolocalización precisa</p>
          </div>
          <div className="px-4">
            <h4 className="text-2xl sm:text-3xl md:text-4xl font-black text-orange-500 mb-2">Tiempo Real</h4>
      ...
      {/* Features */}
      <section id="caracteristicas" className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 lg:px-12 max-w-7xl mx-auto transition-colors duration-300">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white dark:bg-slate-800 p-6 sm:p-8 md:p-10 rounded-[1.5rem] sm:rounded-[2rem] shadow-lg shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-700 hover:-translate-y-2 transition-transform duration-300 group">
      ...
      {/* How it works */}
      <section id="como-funciona" className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 lg:px-12 bg-slate-50 dark:bg-slate-900/50 border-t border-slate-200 dark:border-slate-800 transition-colors duration-300">
      ...
      <section className="relative py-12 sm:py-16 md:py-24 px-4 sm:px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-slate-300 mb-6 sm:mb-8 md:mb-10 leading-relaxed max-w-2xl mx-auto">
            Únete a la red ciudadana que está construyendo calles más seguras y eficientes para todos los conductores y peatones.
          </p>
          <Link href="/login">
            <button className="bg-orange-500 text-white px-8 py-4 sm:px-10 sm:py-5 rounded-full font-bold text-base sm:text-lg hover:bg-orange-400 hover:shadow-[0_0_40px_-10px_rgba(249,115,22,0.5)] transition-all transform hover:-translate-y-1">
